...
export class GetPage {
  ...
  getWeather(cityname) {
    ...
    .then((data:any )=> {
      ...
      this.icon = "http://openweathermap.org/img/w/" + this.weatherDAta[0].icon + ".png";
      ...
      // this.dt2 = this.weather[13].dt_txt.substr(0,10);


      // this.dt3 = this.weather[20].dt_txt.substr(0,10);
